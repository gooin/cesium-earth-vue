            ...
            showPosition() {
                ...
                moveHandler.setInputAction(function (move) {
                    ...
                    if (position !== undefined) {
                        ...
                        it.lon = it.$t('tooltips.status.lon') + lonDMS;
                        // it.lon = "_" + this.$t('tooltips.stats.lon') + ":" + +lonDMS;
                        // it.lon = it.$t('tooltips.status.lon');
                        it.lat = it.$t('tooltips.status.lat') + latDMS;
                        ...
                        if (viewer.terrainProvider._availability) {
                            ...
                            if (it.camHeightNum < 2000000 && it.camHeightNum !== 0) {
                                it.alt = it.$t('tooltips.status.alt') + alt.toFixed(0) + it.$t('tooltips.unit.m');
                            } else {
                                it.alt = "";
                            }
                        }
            ...
            showCamHeight() {
                ...
                viewer.scene.postRender.addEventListener(function () {
                    ...
                    if (cameraHeight < 10000) {
                        ...
                        it.camHeight =
                            it.$t('tooltips.status.camHeight') + parseFloat(cameraHeight).toFixed(0) + it.$t('tooltips.unit.km');
                    }
